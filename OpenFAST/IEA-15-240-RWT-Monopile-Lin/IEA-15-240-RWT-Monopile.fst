...
10                      NLinTimes   - Number of times to linearize (-) [>=1] [unused if Linearize=False]
60, 61, 62, 63, 64, 65, 66, 67, 68, 69                 LinTimes    - List of times at which to linearize (s) [1 to NLinTimes] [unused if Linearize=False]
